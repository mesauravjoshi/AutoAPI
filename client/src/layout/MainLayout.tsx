...
export default function MainLayout() {
  ...
  const isAsssideRequired = () => {
    return location.pathname === '/workspace' || location.pathname === '/workspace/list' || location.pathname === '/environments' || location.pathname === '/profile' || location.pathname === '/team' || location.pathname === '/invites'
  }
